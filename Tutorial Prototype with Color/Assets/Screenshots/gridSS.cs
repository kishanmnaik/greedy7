...
public class gridSS : MonoBehaviour
{
    ...
    public void initializeGrid()
    {
        ...
        /* tileArray[0] = new Tile(1, 0, btnList[0]);
        tileArray[1] = new Tile(2, 1, btnList[1]);
        tileArray[2] = new Tile(0, 2, btnList[2]);
        tileArray[3] = new Tile(2, 3, btnList[3]);
        tileArray[4] = new Tile(0, 4, btnList[4]);
        tileArray[5] = new Tile(4, 5, btnList[5]);
        scoreValA = 4;
        scoreA.GetComponentInChildren<Text>().text = "A: " + scoreValA;
        scoreValB = 5;
        scoreB.GetComponentInChildren<Text>().text = "B: " + scoreValB; */
    }
    ...
    public void swapBoard()
    {
        ...
        {
            tileArray[i].setVal(tileArray[i].getVal() + tileArray[gridSize - (i + 1)].getVal());
            tileArray[gridSize - (i + 1)].setVal(tileArray[i].getVal() - tileArray[gridSize - (i + 1)].getVal());
            tileArray[i].setVal(tileArray[i].getVal() - tileArray[gridSize - (i + 1)].getVal());
        }
    ...
    void Update()
    {
        ...
        if (!win)
        {
            if (turn == 1)
            {
                scoreA.color = new Color32(79, 195, 247, 255);
                scoreB.color = Color.white;
            }
            else
            {
                scoreB.color = new Color32(79, 195, 247, 255);
